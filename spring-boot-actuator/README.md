...
**mvn clean package** -> install workable jar file under target directory
...
after all run **mvn clean** for clean up(delete workable jar file under target directory)